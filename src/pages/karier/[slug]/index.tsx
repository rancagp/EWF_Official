        ...
        <Container title={t('join_our_team', 'Bergabunglah dengan Tim Kami')}>
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-8">
              {/* Responsibilities */}
              <div className="bg-white p-6 border-l-4 border-[#F2AC59] shadow-sm">
                <div className="flex items-start">
                  <div className="flex-shrink-0 h-10 w-10 rounded-full bg-[#FEF6E8] flex items-center justify-center text-[#F2AC59] mr-4">
              ...
              <div className="bg-white p-6 border-l-4 border-[#F2AC59] shadow-sm">
                <div className="flex items-start">
                  <div className="flex-shrink-0 h-10 w-10 rounded-full bg-gray-100 flex items-center justify-center text-[#F2AC59] mr-4">
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
